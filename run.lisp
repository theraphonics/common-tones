...
(defun run-type->class (type) ;first (second?) step in gen-unload process -- get type, dispatch to method
  (cond
   ...
   ((= type +string+) "1")
;   ((= type +frame+) (make-instance 'common-tones::frame))
;   ((= type +mixer+) (make-instance 'common-tones::mixer))
   ((= type +oscil+) (make-instance 'common-tones::oscil))
   ((= type +ncos+) (make-instance 'common-tones::ncos))
   ((= type +nrxycos+) (make-instance 'common-tones::nrxycos))
   ((= type +nsin+) (make-instance 'common-tones::nsin))
   ((= type +nrxysin+) (make-instance 'common-tones::nrxysin))
   ((= type +ssb-am+) (make-instance 'common-tones::ssb-am))
   ((= type +rand+) (make-instance 'common-tones::rand))
   ((= type +rand-interp+) (make-instance 'common-tones::rand-interp))
   ((= type +table-lookup+) (make-instance 'common-tones::table-lookup))
   ((= type +square-wave+) (make-instance 'common-tones::square-wave))
   ((= type +pulse-train+) (make-instance 'common-tones::pulse-train))
   ((= type +sawtooth-wave+) (make-instance 'common-tones::sawtooth-wave))
   ((= type +triangle-wave+) (make-instance 'common-tones::triangle-wave))
   ((= type +asymmetric-fm+) (make-instance 'common-tones::asymmetric-fm))
   ((= type +wave-train+) (make-instance 'common-tones::wave-train))
   ((= type +one-pole+) (make-instance 'common-tones::one-pole))
   ((= type +two-pole+) (make-instance 'common-tones::two-pole))
   ((= type +one-zero+) (make-instance 'common-tones::one-zero))
   ((= type +two-zero+) (make-instance 'common-tones::two-zero))
   ((= type +delay+) (make-instance 'common-tones::delay))
   ((= type +tap+) (make-instance 'common-tones::tap))
   ((= type +comb+) (make-instance 'common-tones::comb))
   ((= type +filtered-comb+) (make-instance 'common-tones::filtered-comb))
   ((= type +notch+) (make-instance 'common-tones::notch))
   ((= type +all-pass+) (make-instance 'common-tones::all-pass))
   ((= type +moving-average+) (make-instance 'common-tones::moving-average))
   ((= type +filter+) (make-instance 'common-tones::filter))
   ((= type +fir-filter+) (make-instance 'common-tones::fir-filter))
   ((= type +iir-filter+) (make-instance 'common-tones::iir-filter))
   ((= type +env+) (make-instance 'common-tones::seg))
   ((= type +locsig+) (make-instance 'common-tones::locsig))
   ((= type +move-sound+) (make-instance 'common-tones::move-sound))
   ((= type +src+) (make-instance 'common-tones::src))
   ((= type +granulate+) (make-instance 'common-tones::granulate))
   ((= type +readin+) (make-instance 'common-tones::readin))
   ((= type +convolve+) (make-instance 'common-tones::convolve))
   ((= type +polyshape+) (make-instance 'common-tones::polyshape))
   ((= type +polywave+) (make-instance 'common-tones::polywave))
   ((= type +firmant+) (make-instance 'common-tones::firmant))
   ((= type +formant+) (make-instance 'common-tones::formant))
   ((= type +sample2file+) (make-instance 'common-tones::sample->file))
   ((= type +frample2file+) (make-instance 'common-tones::frample->file))
   ((= type +file2sample+) (make-instance 'common-tones::file->sample))
   ((= type +file2frample+) (make-instance 'common-tones::file->frample))
   ((= type +phase-vocoder+) (make-instance 'common-tones::phase-vocoder))
...
(defmethod gen-make ((gen move-sound) stream result iloc indent ctr)
  ...
  (gen-make (make-instance 'common-tones::delay) stream "doppler_delay" "iloc" indent ctr)

  (format stream "~Ailoc = CLM_ILOC(~A) + 8;~%" indent iloc)
  (gen-make (make-instance 'common-tones::seg) stream "doppler_env" "iloc" indent ctr)

  (format stream "~Ailoc = CLM_ILOC(~A) + 10;~%" indent iloc)
  (gen-make (make-instance 'common-tones::seg) stream "rev_env" "iloc" indent ctr)

  (format stream "~Ailoc = CLM_ILOC(~A) + 12;~%" indent iloc)
  (move-sound-array-make (make-instance 'common-tones::delay) stream "out_delays" indent)

  (format stream "~Ailoc = CLM_ILOC(~A) + 14;~%" indent iloc)
  (move-sound-array-make (make-instance 'common-tones::seg) stream "out_envs" indent)

  (format stream "~Ailoc = CLM_ILOC(~A) + 16;~%" indent iloc)
  (move-sound-array-make (make-instance 'common-tones::seg) stream "rev_envs" indent)
